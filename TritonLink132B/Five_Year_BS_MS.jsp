        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        // INSERT the Graduate attributes INTO the Graduate table.
                        PreparedStatement pstmt = conn.prepareStatement(
                            "INSERT INTO Five_Year_BS_MS VALUES (?)");

                        pstmt.setInt(1, Integer.parseInt(request.getParameter("G_SSN")));
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE Graduate SET ID = ?, First Name = ?, " +
            ...
            <%
                    ...
                    // the Graduate attributes FROM the Graduate table.
                    ResultSet rs = statement.executeQuery
                        ("SELECT * FROM Five_Year_BS_MS");
            %>

            <!-- Add an HTML table header row to format the results -->
                <table border="1">
                    <tr>
                        <th>5 Year BS/MS SSN</th>
                      
                        <th>Action</th>
                    </tr>
                    <tr>
                        <form action="Five_Year_BS_MS.jsp" method="get">
                            <input type="hidden" value="insert" name="action">
                            <th><input value="" name="G_SSN" size="30"></th>
            ...
            %>
                    ...
                    <tr>
                        ...
                        <form action="Five_Year_BS_MS.jsp" method="get">
                            ...
                            <input type="hidden" 
                                value="<%= rs.getInt("G_SSN") %>" name="G_SSN">
                            <%-- Button --%>
                            <td>
