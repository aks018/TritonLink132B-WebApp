        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        pstmt.setString(3, request.getParameter("First Name"));
                       pstmt.setString(4, request.getParameter("Middle Name"));
                        pstmt.setString(5, request.getParameter("Last Name"));
                        pstmt.setString(6, request.getParameter("Residency"));
						pstmt.setString(7, request.getParameter("College"));
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE Student SET ID = ?, First Name = ?, " +
			...
			<th>Middle</th>
                    ...
                    <tr>
                        <form action="students.jsp" method="get">
                            ...
                            <th><input value="" name="First Name" size="15"></th>
            ...
            %>
                    ...
                    <tr>
                        <form action="students.jsp" method="get">
                            ...
                            <%-- Get the First Name --%>
                            <td>
                                <input value="<%= rs.getString("First Name") %>"
                                    name="First Name" size="15">
                            </td>
    
                            <%-- Get the Last Name --%>
                            <td>
                                <input value="<%= rs.getString("Middle Name") %>" 
                                    name="Middle Name" size="15">
                            </td>
    
			    <%-- Get the Last Name --%>
                            <td>
                                <input value="<%= rs.getString("Last Name") %>" 
