        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        // INSERT the Prerequisites attributes INTO the Prerequisites table.
                        PreparedStatement pstmt = conn.prepareStatement(
                            "INSERT INTO Prerequisites VALUES (?,?)");

                        pstmt.setString(1, request.getParameter("Course_Number"));
						pstmt.setString(2, request.getParameter("Pre_Req"));
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        // Create the prepared statement and use it to
                        // UPDATE the Prerequisites attributes in the Prerequisites table.
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE Prerequisites SET ID = ?, First Name = ?, " +
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        // Create the prepared statement and use it to
                        // DELETE the Prerequisites FROM the Prerequisites table.
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM Prerequisites WHERE SSN = ?");
            ...
            <%
                    ...
                    // the Prerequisites attributes FROM the Prerequisites table.
                ...
                <table border="1">
                    ...
                    <tr>
                        <form action="Prerequisites.jsp" method="get">
                            ...
                            <th><input value="" name="Course_Number" size="30"></th>
							<th><input value="" name="Pre_Req" size="30"></th>
                        ...
                        <form action="Prerequisites.jsp" method="get">
                            ...
                            <td>
                                <input value="<%= rs.getString("Course_Number") %>" 
                                    name="Course_Number size="30">
                            </td>
							<td>
                                <input value="<%= rs.getString("Pre_Req") %>" 
                                    name="Major size="30">
                            </td>
