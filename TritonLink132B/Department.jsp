        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        pstmt.setString(1, request.getParameter("Department Name"));
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE Department SET ID = ?, First Name = ?, " +
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM Department WHERE SSN = ?");
                ...
                <table border="1">
                    ...
                    <tr>
                        <form action="Department.jsp" method="get">
                            ...
                            <th><input value="" name="Department Name" size="30"></th>
            ...
            %>
                    ...
                    <tr>
                        <form action="Department.jsp" method="get">
                            ...
                            <td>
                                <input value="<%= rs.getString("Department Name") %>" 
                                    name="Department Name" size="30">
                            </td>
                        ...
                        <form action="Department.jsp" method="get">
                            ...
                            <input type="hidden" 
                                value="<%= rs.getString("Department Name") %>" name="Department Name">
                            <%-- Button --%>
                            <td>
