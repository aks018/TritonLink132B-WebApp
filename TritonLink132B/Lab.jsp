        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        // INSERT the Lab attributes INTO the Lab table.
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        // Create the prepared statement and use it to
                        // UPDATE the Lab attributes in the Lab table.
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE Lab SET ID = ?, First Name = ?, " +
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        // Create the prepared statement and use it to
                        // DELETE the Lab FROM the Lab table.
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM Lab WHERE SSN = ?");
            ...
            <%
                    ...
                    // the Lab attributes FROM the Lab table.
                ...
                <table border="1">
                    ...
                    <tr>
                        <form action="Lab.jsp" method="get">
                            ...
                            <th><input value="" name="Lab_ID" size="30"></th>
            ...
            %>
                    ...
                    <tr>
                        ...
                        <form action="Lab.jsp" method="get">
                            ...
                            <input type="hidden" 
                                value="<%= rs.getInt("Lab_ID") %>" name="Lab_ID">
                            <%-- Button --%>
                            <td>
